  ...
  layers: [
    {
      ...
      type: "background",
      paint: {
        "background-color": "#f4f6f8", // Lightened from #cccccc
      },
    },
    {
      id: "earth",
      ...
      "source-layer": "earth",
      paint: {
        "fill-color": "#ffffff", // Brightened to pure white for a clean look
      },
    },
    {
      id: "landcover",
      ...
      paint: {
        "fill-color": [
          ...
          ["get", "kind"],
          "grassland",
          "rgba(240, 248, 238, 1)", // Softer, lighter pastel green
          "barren",
          "rgba(250, 250, 248, 1)",
          "urban_area",
          "rgba(247, 247, 247, 1)",
    ...
    },
    {
      ...
      paint: {
        ...
        "fill-color": [
          ...
          "#e6f2eb", // Much lighter, subtle park green
          ["==", ["get", "kind"], "wood"],
          "#e8f4e8",
    ...
    },
    {
      ...
      "source-layer": "water",
      paint: {
        "fill-color": "#dbe9f6", // Very soft, airy blue instead of bright cyan
      },
    },
    {
      id: "water_stream",
    ...
    },
    {
      ...
      paint: {
        "fill-color": "#e8e8ea", // Lighter buildings so they blend seamlessly
        "fill-opacity": 0.6,
      },
    },
    {
    ...
    },
    {
      ...
      paint: {
        "line-color": "#ebebeb", // Softened from #e0e0e0
        "line-gap-width": [
          "interpolate",
          ["exponential", 1.6],
          ["zoom"],
    ...
    },
    {
      ...
      paint: {
        "line-color": "#e6e6e6", // Lightened major road casings
        "line-gap-width": [
          "interpolate",
          ["exponential", 1.6],
          ["zoom"],
    ...
    },
    {
      ...
      paint: {
        ...
        "line-opacity": 0.5,
        "line-color": "#cccccc", // Softened rail lines
        "line-width": [
          "interpolate",
          ["exponential", 1.6],
          ["zoom"],
    ...
    },
    {
      ...
      filter: ["all", ["has", "is_bridge"], ["==", "kind", "major_road"]],
      paint: {
        "line-color": "#ffffff", // Was #f5f5f5, keeping clean white
        "line-width": [
          "interpolate",
          ["exponential", 1.6],
          ["zoom"],
    ...
    },
    {
      ...
      paint: {
        "text-color": "#8aadc4", // Adjusted for the lighter blue water
        "text-halo-color": "#ffffff",
        "text-halo-width": 1,
      },
    },
    ...
    },
    {
      ...
      paint: {
        "text-color": [
          ...
          "#5b9c74", // Softer green for nature POIs
          [
            "in",
            ["get", "kind"],
            ["literal", ["aerodrome", "station", "bus_stop", "ferry_terminal"]],
          ],
          "#758cd9", // Softer blue for transit POIs
          [
            "in",
            ["get", "kind"],
            [
